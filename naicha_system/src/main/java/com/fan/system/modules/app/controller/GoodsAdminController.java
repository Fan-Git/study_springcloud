...
import com.fan.system.modules.app.mapper.GoodsAdminMapper;
import com.fan.system.modules.app.service.GoodsAdminService;
...
public class GoodsAdminController {
    ...
    public static final String NAICHA_SYSTEM_GENERAL= "http://NAICHA-SYSTEM-GENERAL";
    ...
    public Result<Page<GoodsDTO>> getGoodsAdminByPage(@RequestParam(defaultValue = "1") int pageNo,
        ...
        return restTemplate.getForObject( NAICHA_GOODS_SERVICE+"/goods/page?pageNo="+pageNo
                +"&pageSize="+pageSize, Result.class);
    }
