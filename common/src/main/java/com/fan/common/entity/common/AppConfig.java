package com.fan.common.entity.common;
...
*/
    ...
    private String lianxidianhua1 = "18383507282";

    @ApiModelProperty("联系电话2")
    private String lianxidianhua2 = "15700192440";

    @ApiModelProperty("联系QQ")
    private String lianxiQQ = "691567915";

    @ApiModelProperty("店铺开放状态, 商家休息|营业中")
    private Boolean shopStatus = true;

    @ApiModelProperty("菜单上面的公告通知")
    private String shopNotice = "10点到24点可以送餐~";
